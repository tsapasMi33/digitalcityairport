...
public class AirplaneTypeController {
    ...
    @PostMapping("/add")
    public ResponseEntity<HttpStatus> add(@Valid @RequestBody AirplaneTypeForm form) {
    ...
    @PutMapping("/{id:^[0-9]+$}")
    public ResponseEntity<AirplaneTypeDTO> update(@PathVariable long id, @Valid @RequestBody AirplaneTypeForm form) {
